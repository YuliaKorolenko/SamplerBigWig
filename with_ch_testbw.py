...
from clickhouseexample import get_line

functions = [get_hdf5lines_bw, get_bwlines_bw, get_lines_bw_3, get_lines_bwbs, get_line]
...
def get_time():
    ...
    plt.plot(sizes, times[4], color="#b3360f", label='clickhouse')
    plt.legend()
