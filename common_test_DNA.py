...
functions = [get_lines_1, get_lines_2, get_lines_4, get_lines_5, get_lines_6, get_lines_7]
...
def get_time():
    ...
    plt.plot(sizes, times[2], color="#F72585", label='hdf5')
    plt.plot(sizes, times[3], color="#7209B7", label='bin files')
    plt.plot(sizes, times[4], color="#4361EE", label='numpy arr')
    plt.plot(sizes, times[5], color="#4CC9F0", label='simple')
    plt.legend()
    plt.show()
